<template>
    <div class="main-activity">
        <div class="row">
            ...
            <div id="search">
                <v-text-field id="search" prepend-icon="mdi-magnify" v-model="searchQuery" @input="getMak"></v-text-field>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getMak() {
            this.documents = []
            const collectionRef = db.collection("Making");
            if (this.searchQuery === "") {
            ...
            console.log("Making documents: ", this.documents);
        },
    },
};
</script>
