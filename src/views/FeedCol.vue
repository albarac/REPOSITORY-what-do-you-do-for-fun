<template>
    <div class="main-activity">
        <div class="row">
            ...
            <div id="search">
                <v-text-field id="search" prepend-icon="mdi-magnify" v-model="searchQuery" @input="getCol"></v-text-field>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getCol() {
            this.documents = []
            const collectionRef = db.collection("Collecting");
            if (this.searchQuery === "") {
                collectionRef.onSnapshot((querySnapshot) => {
                    this.documents = querySnapshot.docs.map((doc) => doc.data());
                });
            } else {
                db.collection("Collecting")
            ...
            console.log("Collecting documents: ", this.documents);
        },
    },
};
</script>
